...
tar xzf apache-activemq-5.14.0-bin.tar.gz
cd apache-activemq-5.14.0
bin/activemq start   # daemon
#bin/activemq console # foreground
#bin/activemq stop    # stop

# start
cd ~/gs-messaging-jms/complete
mvn spring-boot:run
```

== Reference
include::http://docs.spring.io/spring/docs/current/spring-framework-reference/htmlsingle/#jms[]
include::http://docs.spring.io/spring-boot/docs/1.4.1.RELEASE/reference/htmlsingle/#boot-features-jms[]