...
mvn spring-boot:run -Drun.arguments="--spring.activemq.broker-url=tcp://127.0.0.1:61616"
```

== Reference
* http://docs.spring.io/spring/docs/current/spring-framework-reference/htmlsingle/#jms
* http://docs.spring.io/spring-boot/docs/1.4.1.RELEASE/reference/htmlsingle/#boot-features-jms